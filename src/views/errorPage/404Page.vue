  ...
  <div>
    ...
    <div class="container container-bird">
      ...
      <div class="container-title">
        ...
        <div class="subtitle">哎呀，看来你拐错弯了！<span @click="go_back()">返回</span></div>
      </div>
    </div>
  </div>
</template>
...
.container-star {
  background-image: linear-gradient(to bottom, #409eff 0%, #409effb5 70%, #409eff80 100%);
  /* background-image: linear-gradient(to bottom, #409eff 0%, #409effb5 70%, #409eff80 100%); */
}
...
.moon {
  ...
  z-index: 2;
  background-color: #fff;
  /* box-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #fff, 0 0 40px #fff, 0 0 70px #fff, 0 0 80px #fff, 0 0 100px #1170ff; */
